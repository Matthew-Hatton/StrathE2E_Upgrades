...
e2e_compare_annual_obs_models <- function(
    model_1,
    model_2,
    g_map = group_map,
    n_map = name_map) {
    ...
    m1_target <- StrathE2E2:::read_annual_target_data(model_1$setup$model.path)
    m1_name <- model_1$setup$model.name
    m1_target$model <- m1_name

    m2_target <- StrathE2E2:::read_annual_target_data(model_2$setup$model.path)
